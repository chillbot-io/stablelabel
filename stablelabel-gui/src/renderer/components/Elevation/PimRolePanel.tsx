...
export default function PimRolePanel() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-sm font-semibold text-gray-300 mb-1">PIM Role Activation</h3>
        <p className="text-xs text-gray-500">Activate an eligible Entra ID role via Privileged Identity Management.</p>
      </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded p-3">
        <h4 className="text-xs text-gray-500 mb-2">Common Role IDs</h4>
      ...
      <button onClick={handleClick} disabled={loading} className="px-4 py-2 text-xs font-medium text-purple-300 bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/20 rounded transition-colors disabled:opacity-50">
