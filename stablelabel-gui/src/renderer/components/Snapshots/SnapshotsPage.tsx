    ...
    <div className="flex h-full">
      ...
      <div className="w-64 flex-shrink-0 border-r border-gray-800 flex flex-col bg-gray-950">
        <div className="p-3 border-b border-gray-800">
          <h2 className="text-sm font-semibold text-gray-300">Snapshots</h2>
          <p className="text-[10px] text-gray-500 mt-0.5">Capture, compare, and restore tenant config</p>
        </div>
        ...
        <div className="p-2 border-t border-gray-800">
          <button onClick={() => setView({ type: 'create' })} className="w-full py-1.5 text-xs text-blue-300 hover:text-blue-200 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 rounded transition-colors">
            + New Snapshot
          </button>
        </div>
      </div>
        ...
        {view.type === 'empty' && (
          <div className="h-full flex items-center justify-center">
            <div className="text-center max-w-md">
              <h2 className="text-lg font-semibold text-gray-300 mb-2">Select a snapshot or create new</h2>
              <p className="text-sm text-gray-500 mb-4">Snapshots capture your tenant's labels, policies, and rules for comparison or rollback.</p>
              <button onClick={() => setView({ type: 'create' })} className="px-4 py-2 text-xs text-blue-300 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 rounded transition-colors">
                + New Snapshot
              </button>
            </div>
          </div>
