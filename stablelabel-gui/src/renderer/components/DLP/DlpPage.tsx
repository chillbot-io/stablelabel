    ...
    <div className="h-full flex items-center justify-center">
      <div className="text-center max-w-lg">
        ...
        <div className="flex gap-3 justify-center">
          <button
            onClick={onNewPolicy}
            className="px-4 py-2 text-xs text-red-300 bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 rounded-lg transition-colors"
          >
            + New DLP Policy
          </button>
          <button
            onClick={onNewRule}
            className="px-4 py-2 text-xs text-orange-300 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/20 rounded-lg transition-colors"
          >
            + New DLP Rule
          </button>
        </div>
